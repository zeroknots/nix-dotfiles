...
vim.keymap.set('n', '<leader>fmt', ':!forge fmt<CR>')

vim.keymap.set('n', '<leader>fmt', ':!pnpm -r fmt; forge fmt<CR>')
...
require('lazy').setup({
      ...
      return {
        ...
        custom_highlights = function(colors)
          return {
            ...
            ['@keyword.return'] = { fg = colors.lavender, style = { 'bold' } },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      indent = { enable = false, disable = { 'ruby', 'solidity' } },
    },
